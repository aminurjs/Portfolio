import { FaGithub, FaAngleRight, FaFacebook, FaLinkedin, FaTwitter } from "react-icons/fa6";
        ...
        <div className=" flex gap-12 py-16 items-center px-5 flex-col md:flex-row">
          <div className="md:border border-yellow-20 p-3 relative w-full md:w-2/5 lg:w-1/2 ml-5 md:mr-5">
            ...
            <div className="-mt-16 mx-auto md:absolute top-10 -right-6 w-48 md:w-28 lg:w-40 border-8 border-yellow-20 rounded-full overflow-hidden z-10">
              <img className="scale-[1.1]" src="./public/aminur.jpg" alt="" />
            </div>
          </div>
          <div className=" text-center md:text-left w-full md:w-3/5 lg:w-1/2 md:mt-6">
            <h3 className="text-yellow-20 tracking-[5px] mb-3">WELCOME TO MY WEBSITE</h3>
            ...
            <div className="text-white mb-8">
              <p>
                I specialize in front-end and MERN Stack web development. My expertise in coding,
                troubleshooting intricate designs, and ensuring project completion within deadlines.
              </p>

              <p>
                I am dedicated to leveraging intelligent ideas through innovative, standards-based,
                and open-source front-end and MERN Stack development. Always eager for new
                challenges, I actively seek opportunities to forge meaningful connections in the
