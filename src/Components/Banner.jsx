...
const Banner = () => {
  return (
    <div className="bg-[url(https://i.ibb.co/DYjLg47/2150898496.jpg)] bg-right-top bg-black">
        ...
        <div className="bg-gradient-to-t from-black pt-36 pb-28">
          <div className="max-w-7xl mx-auto my-10 px-5 lg:px-0">
            ...
            <p className="text-base md:text-lg text-gray-100  max-w-2xl mb-10">
              {"I'm"} a passionate Front End Developer with a love for creating seamless user
              experiences. I specialize in React and enjoy turning complex problems into elegant,
              intuitive solutions.
            </p>
            <a href="#projects">
